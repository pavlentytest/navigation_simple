package ru.samsung.itschool.mdev.myapplication.fragment;
...
public class RootFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mParam1 = getArguments().getString("back");
            Snackbar.make(getActivity().findViewById(R.id.root),mParam1,Snackbar.LENGTH_LONG).show();
